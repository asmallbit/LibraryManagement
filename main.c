...
int main()
{
    ...
    char *input, *bookname, *author, *buffer;
    ...
    label:
        ...
        label2:
            ...
            label3:
                ...
                printf("请输入你要借的书的书名 ");
                bookname = getString();
                if (getBorrow(book, borrow, bookname, id, dateSeconds, index, choice))
                {
                    printf("借书成功!\n");
                    getBorrowDate();
                }
        ...
        else
        {
            ...
            else
            {
                ...
                freePBook(book);
                freePBorrow(borrow);
                //释放bookname, input, buffer, author 考虑第一次运行时bookname等指针没有申请空间的情况   待补充
            }
        }
        printf("\n**************************************\n");
    }
